...
function AdminItemsPage({ onBack }) {
  ...
  const validateForm = () => {
    ...
    if (!isEditing) {
      const itemIdExists = items.some((item) => Number(item.item_id) === Number(formData.item_id));
      if (itemIdExists) {
    ...
    <main className="main-item-page">
      <section className="admin-layout">
        <header className="page-header">
          ...
          {onBack ? (
            <button className="history-btn" onClick={onBack} type="button">
              Back to Items
            </button>
          ) : (
        ...
        <article className="admin-card">
          ...
          <form className="admin-form" onSubmit={handleSubmit}>
            ...
            <div className="image-upload" role="group" aria-label="Upload item image">
              {formData.item_image ? (
                    ...
                    return (
                      <tr key={id}>
                        ...
                        <td className="admin-table-actions">
                          <button className="return-btn" type="button" onClick={() => handleEdit(item)}>
                            Edit
                          </button>
                          <button
